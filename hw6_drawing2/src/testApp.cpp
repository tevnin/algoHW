...
//        VF.addClockwiseCircle(ofRandom(ofGetWidth()), ofRandom(ofGetHeight()), 100, 0.6f);
//    }
...
//	prevMouseY = y;
    ...
    VF.addOutwardCircle(x, y, 100, 0.6f);
}
